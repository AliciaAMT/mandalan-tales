...
$enemymaxmana = 0;
$enemycondition = 'Good';
$enemyatt1 = 'Slight Scratch';
$enemyatt1dam = 10;
$enemyatt2 = 'Gnawing Bite';
$enemyatt2dam = 12;
$enemypower = 'Plague';
$event = 'Select an Option<br />';
$enemyspeed = 25;
$enemyagility = 25;
$enemystrength = 5;
$enemyblock=0;
...
//**************set enemy*****************
$stmt = $db->prepare("UPDATE enemy SET enemy = :enemy, enemylevel = :enemylevel, enemyname = :enemyname, enemylife=:enemylife, enemymaxlife=:enemymaxlife, enemymana=:enemymana, enemymaxmana=:enemymaxmana, enemycondition=:enemycondition, enemyatt1=:enemyatt1, enemyatt1dam=:enemyatt1dam, enemyatt2=:enemyatt2, enemyatt2dam=:enemyatt2dam, enemypower=:enemypower, event=:event, enemyspeed=:enemyspeed, enemyagility=:enemyagility, enemystrength=:enemystrength, enemyblock=:enemyblock, enemyaccuracy=:enemyaccuracy, fight=:fight WHERE charname= :charname") ;
				$stmt->execute(array(':enemy' => $enemy, ':enemylevel' => $enemylevel, ':enemyname' => $enemyname, ':enemylife' => $enemylife, ':enemymaxlife' => $enemymaxlife, ':enemymana' => $enemymana, ':enemymaxmana' => $enemymaxmana, ':enemycondition' => $enemycondition, ':enemyatt1' => $enemyatt1, ':enemyatt1dam' => $enemyatt1dam, ':enemyatt2' => $enemyatt2, ':enemyatt2dam' => $enemyatt2dam, ':enemypower' => $enemypower, ':event' => $event, ':enemyspeed' => $enemyspeed, ':enemyagility' => $enemyagility, ':enemystrength' => $enemystrength,  ':enemyblock' => $enemyblock, ':enemyaccuracy' => $enemyaccuracy, ':fight' => $fight,
				':charname' => $charname));
//*************include clear counters****************
$stmt = $db->prepare("UPDATE counters SET ebleed=0, held=0, bleeding=0,  inferno=0, frozen=0, stunned=0, poisoned=0, eheld=0, einferno=0, efrozen=0, estunned=0, epoisoned=0 WHERE charname= :charname") ;
				$stmt->execute(array(':charname' => $charname));
				include ('../includes/getestats.php');
?>
<div class="container-fluid" style="margin: 0px 0px 0px 0px;">
<div class="row">
<div class="col-sm-12" style="max-height: 30%;">
<div class="fightlog">
<?php
//***************include fightlog (event)*************
  echo $event;
?>
</div>
</div>
