...
{
	if (!window['imageButtons'       ])
		return;

	if (!window['imageButtonElement' ])
		return;

	if (!window['imageButtonMouseBtn'])
		return;

	if ( window['imageButtonMouseBtn'](e) != 1)
		return;
...
function imageButtonEnter(e)
{
	...
	if (!window['imageButtons'][window['imageButtonElement'](e).id])
		return;
