...
if ($row['duality']>0) {
echo "<table><tr><td class=\"center\" style=\"width: 50%\"><form name=\"tequiplh\" action=\"inventory.php?".time();
  echo "\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"tequiplh\" checked=\"checked\" value=\"".$row['itemnumber'];
  echo "\"><input type=\"submit\" value=\"Equip Left\" class=\"small\"></form></td><td class=\"center\" style=\"width: 50%\"><form name=\"tequiprh\" action=\"inventory.php?".time();
  echo "\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"tequiprh\" checked=\"checked\" value=\"".$row['itemnumber'];
  echo "\"><input type=\"submit\" value=\"Equip Right\" class=\"small\"></form></td></tr><tr><td class=\"center\" colspan=\"2\"><form name=\"keep\" action=\"inventory.php?".time();
  echo "\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"keep\" checked=\"checked\" value=\"".$row['itemnumber'];
  echo "\"><input type=\"submit\" value=\"Keep\" class=\"small\"></form></td></tr></table>";
  }
//add flag equipable and criticalhit
if ($row['duality']==0 and $row['equipable']==1) {
  echo "<table><tr><td><form name=\"tequip\" action=\"inventory.php?".time();
  echo "\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"tequip\" checked=\"checked\" value=\"".$row['itemnumber'];
  echo "\"><input type=\"submit\" value=\"Equip\" class=\"small\"></form></td></tr><tr><td><form name=\"keep\" action=\"inventory.php?".time();
  echo "\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"keep\" checked=\"checked\" value=\"".$row['itemnumber'];
  echo "\"><input type=\"submit\" value=\"Keep\" class=\"small\"></form></td></tr></table>";
  }
echo "<hr />";
