...
mysql_query ($query);
  ...
  echo "Marah";
  include ('php/npcdialogue.php');
  echo "So do you have the fried eggs for me yet?";
  include ('php/usericon.php');
  include ('php/getfriedeggs.php');
  if ($friedeggs<1)
  {
  echo "<table class=\"page\" width=\"100%\"><tr><td class=\"center\" width=\"15%\"><form action=\"../maingraphics.php?";
echo time();
...
$query=sprintf("update flags set marah=6 where username='%s';", mysql_real_escape_string($username));
mysql_query ($query);
...
$query=sprintf("update cookbook set friedeggs=1 where username='%s';", mysql_real_escape_string($username));
  mysql_query ($query);
